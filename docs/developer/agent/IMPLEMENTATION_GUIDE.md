...
All paths relative to `packages/starboard-server/starboard_server/`.
...
**File 1:** `packages/starboard-server/starboard_server/prompts/base.py`
...
**File 2:** `packages/starboard-server/starboard_server/agents/routing/routing_models.py`
...
```
packages/starboard-server/starboard_server/prompts/my_new_domain/
    __init__.py
    v1.py
```
...
**File:** `packages/starboard-server/starboard_server/prompts/factories.py`

```python
from starboard_server.prompts.my_new_domain.v1 import build_system_prompt as my_new_domain_prompt
...
**File:** `packages/starboard-server/starboard_server/agents/tool_categories.py`
...
**File:** `packages/starboard-server/starboard_server/agents/tool_display.py`
...
- [Tool Categories Source](../../../packages/starboard-server/starboard_server/agents/tool_categories.py) -- Canonical tool mappings
