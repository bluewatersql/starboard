...
- [System Architecture](../../architecture/SYSTEM_ARCHITECTURE.md)
- [Router Prompt Source](../../../packages/starboard/starboard/prompts/router/v1.py)
- [Domain Intents Source](../../../packages/starboard/starboard/agents/routing/domain_intents.py)
- [Intent Router Source](../../../packages/starboard/starboard/agents/routing/intent_router.py)
