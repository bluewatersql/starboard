...
- [System Architecture](../../architecture/SYSTEM_ARCHITECTURE.md)
- [Router Prompt Source](https://github.com/starboard-ai/job-agent/blob/main/packages/starboard/starboard/prompts/router/v1.py)
- [Domain Intents Source](https://github.com/starboard-ai/job-agent/blob/main/packages/starboard/starboard/agents/routing/domain_intents.py)
- [Intent Router Source](https://github.com/starboard-ai/job-agent/blob/main/packages/starboard/starboard/agents/routing/intent_router.py)
