---
description: Analyze Databricks cost and usage — fetch billable usage, review budgets, and identify cost optimization opportunities. Use when the user asks about spend, billing, cost drivers, budgets, DBU consumption, or cost optimization across the workspace.
mode: subagent
