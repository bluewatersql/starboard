---
description: Analyze Unity Catalog metadata and governance — explore catalogs, schemas, tables, lineage, and access patterns. Use when the user asks about Unity Catalog, data governance, catalog or schema structure, table lineage, missing metadata, or data organization.
mode: subagent
