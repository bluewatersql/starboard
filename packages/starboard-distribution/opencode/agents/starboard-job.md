---
description: Analyze Databricks jobs and workflows — fetch configuration, inspect run history, diagnose failures, and recommend optimizations. Use when the user asks about job failures, workflow performance, run history, job scheduling, or retry behavior.
mode: subagent
