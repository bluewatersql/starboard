...
class TestFactoryS3PathRouting:
    ...
    @patch("starboard_log_parser.parsing_models.application.factory._build_s3_loader")
    ...
    def test_local_path_does_not_use_s3(self, tmp_path) -> None:
        ...
        with patch(
            "starboard_log_parser.parsing_models.application.factory._build_s3_loader"
        ) as mock_build_s3:
...
class TestBuildS3Loader:
    ...
    @patch("starboard_log_parser.adapters.cloud.s3.S3Adapter.__post_init__")
    @patch("starboard_log_parser.adapters.cloud.s3.boto3", create=True)
    def test_build_s3_loader_creates_lines_loader(
        ...
        from starboard_log_parser.loaders import ArchiveExtractionThresholds
        from starboard_log_parser.loaders.s3 import S3FileLinesDataLoader
        from starboard_log_parser.parsing_models.application.factory import (
            _build_s3_loader,
        )
