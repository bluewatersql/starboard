...
class TestContainerCacheIntegration:
    ...
    async def test_cache_factory_created_on_init(
        ...
        with (
            patch(
                "starboard_server.infra.core.container.create_state_store",
                return_value=mock_state,
            ),
            patch(
                "starboard_server.infra.core.container.create_memory_store",
                return_value=mock_memory,
            ),
            patch(
                "starboard_server.infra.core.container.create_cache_store",
