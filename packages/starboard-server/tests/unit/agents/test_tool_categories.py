...
def test_module_has_comprehensive_docstring():
    ...
    from starboard_server.agents import tool_categories
...
class TestOfflineModeFiltering:
    ...
    def test_offline_mode_filters_online_tools(self, all_tools):
        ...
        from starboard_server.agents.tool_categories import ONLINE_TOOLS
    ...
    def test_offline_mode_works_for_all_domains(self, all_tools):
        ...
        from starboard_server.agents.tool_categories import ONLINE_TOOLS, AgentDomain
