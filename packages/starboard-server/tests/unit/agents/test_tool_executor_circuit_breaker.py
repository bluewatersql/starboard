...
from starboard_server.agents.output.llm_responses import ToolCall, ToolResult
...
class TestToolExecutorCircuitBreaker:
    ...
    async def test_circuit_opens_after_threshold_failures(self):
        ...
        cb = executor._circuit_breakers["test_tool"]
        from starboard_server.infra.reliability.circuit_breaker import CircuitState
