...
import pytest
from starboard_server.adapters.llm import BaseLLMClient, create_llm_client
...
class TestLLMFactory:
    ...
    def test_create_llm_client_loads_from_env_when_none(self) -> None:
        ...
        with patch("starboard_server.infra.core.config.EnvConfig") as mock_config_class:
    ...
    def test_create_llm_client_logs_provider_selection(self) -> None:
        ...
        with patch("starboard_server.adapters.llm.logger") as mock_logger:
            create_llm_client(cfg=config)
