...
Example:
    >>> from starboard_server.agents.events import create_thinking_event, create_tool_start_event
...
from starboard_server.agents.events.tool_events import ToolEndEvent, ToolStartEvent
from starboard_server.agents.events.user_events import (
    FinalOutputEvent,
    UserInputRequestEvent,
)
from starboard_server.agents.tool_display import get_friendly_name
