...
"""
UC (Unity Catalog) domain prompts - Version 2 (Jinja2).

System prompt for the Unity Catalog governance and analysis agent.
...
"""Semantic version for UC (Unity Catalog) prompts. Increment on any prompt change:
...
def build_system_prompt(
    ...
    """Build uc (unity catalog) agent system prompt using Jinja2 template.
