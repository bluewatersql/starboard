"""
Warehouse domain prompts - Version 2 (Jinja2).

System prompt for the SQL warehouse portfolio optimization agent.
...
def build_system_prompt(
    ...
    """Build warehouse agent system prompt using Jinja2 template.
