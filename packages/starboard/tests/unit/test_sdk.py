...
def _make_tool_end_event(name: str = "resolve_query"):
    ...
    from starboard.agents.events import ToolEndEvent
...
class TestConversationSession:
    ...
    async def test_ask_times_out(self, mock_manager):
        from starboard.sdk.exceptions import TimeoutError as SdkTimeoutError
...
def _make_tool_start_event(name: str = "resolve_query"):
    ...
    from starboard.agents.events import ToolStartEvent
...
class TestAskStream:
    ...
    async def test_ask_stream_yields_error_events(self, mock_manager):
        ...
        assert len(events) == 1
        from starboard.sdk.event_types import ErrorEvent as SdkErrorEvent
...
class TestStarboardClient:
    ...
    async def test_create_session_with_session_mgr(
        ...
        from starboard.cli.sessions.session_manager import SessionInfo
    ...
    async def test_resume_without_session_mgr_raises(self, mock_manager):
        from starboard.sdk.exceptions import SessionError
