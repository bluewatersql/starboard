...
class TestRenderChartEndpoint:
    ...
    async def test_render_png_chart_success(
        ...
        from starboard.api.models.visualization import RenderChartRequest
        from starboard.api.visualization import render_chart
        ...
        with patch("starboard.api.visualization.QueryResultCache") as MockCache:
    ...
    async def test_render_chart_rendering_failure(
        ...
        with patch("starboard.api.visualization.QueryResultCache") as MockCache:
            ...
            with patch(
                "starboard.api.visualization.ChartRenderer"
            ) as MockRenderer:
