...
class TestThreadPoolExecutorShutdown:
    ...
    def test_shutdown_databricks_executor_exists(self) -> None:
        ...
        from starboard.adapters.databricks.services.base import (  # noqa: F401
    ...
    def test_shutdown_databricks_executor_shuts_down_pool(self) -> None:
        ...
        from starboard.adapters.databricks.services.base import (
        ...
        from starboard.adapters.databricks.services import base as base_mod
