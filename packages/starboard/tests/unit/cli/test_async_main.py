...
class TestCreateAgentManager:
    ...
    async def test_creates_manager_successfully(self, mock_config):
        ...
        with (
            patch("starboard.cli.cli.main.create_llm_client") as mock_create_llm,
            patch("starboard.cli.cli.main.AsyncDatabricksClient") as mock_api_class,
            patch("starboard.cli.cli.main.SharedContextProvider"),
            patch("starboard.cli.cli.main.create_tool_registry") as mock_tools,
            patch("starboard.cli.cli.main.IntentRouter"),
            patch("starboard.cli.cli.main.AgentFactory"),
            patch("starboard.cli.cli.main.InMemoryConversationStateManager"),
            patch(
                "starboard.cli.cli.main.MultiAgentConversationManager"
    ...
    async def test_passes_correct_config_to_agent_factory(self, mock_config):
        ...
        with (
            ...
            patch("starboard.cli.cli.main.create_tool_registry") as mock_tools,
            patch("starboard.cli.cli.main.IntentRouter"),
            patch("starboard.cli.cli.main.AgentFactory") as mock_factory,
            patch("starboard.cli.cli.main.InMemoryConversationStateManager"),
            patch("starboard.cli.cli.main.MultiAgentConversationManager"),
        ):
            mock_llm_client = MagicMock()
            mock_create_llm.return_value = mock_llm_client
            mock_api = MagicMock()
...
class TestHandleStreamingEvents:
    ...
    async def test_returns_final_output(self):
        ...
        from starboard.agents.events import FinalOutputEvent
    ...
    async def test_raises_on_error_event(self):
        ...
        from starboard.agents.events import ErrorEvent
    ...
    async def test_generates_formatted_markdown(self):
        ...
        with patch("starboard.bootstrap.format_agent_report") as mock_format:
...
class TestAsyncMain:
    ...
    async def test_exits_on_missing_databricks_credentials(self, mock_args):
        ...
        with (
            patch("starboard.cli.cli.main.load_dotenv"),
            patch("starboard.cli.cli.main.setup_cli_logging"),
            patch("starboard.cli.cli.main.get_config") as mock_get_config,
        ):
    ...
    async def test_exits_on_missing_goal(self, mock_args, mock_config):
        ...
        with (
            ...
            patch("starboard.cli.cli.main.setup_cli_logging"),
            patch("starboard.cli.cli.main.get_config") as mock_get_config,
            patch("starboard.cli.cli.main.merge_env_config") as mock_merge,
        ):
            mock_get_config.return_value = mock_config
    ...
    async def test_loads_config_file_when_provided(
        ...
        with (
            ...
            patch("starboard.cli.cli.main.setup_cli_logging"),
            patch("starboard.cli.cli.main.get_config") as mock_get_config,
            patch("starboard.cli.cli.main.load_config_file") as mock_load_config,
            patch("starboard.cli.cli.main.merge_env_config") as mock_merge,
            patch(
                "starboard.cli.cli.main.create_agent_manager",
