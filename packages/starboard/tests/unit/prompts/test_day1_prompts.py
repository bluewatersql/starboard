...
class TestRouterPrompts:
    ...
    def test_router_prompt_exists(self):
        ...
        from starboard.prompts import ROUTER_SYSTEM_PROMPT
...
class TestQueryPrompts:
    ...
    def test_query_prompt_exists(self):
        ...
        from starboard.prompts import QUERY_SYSTEM_PROMPT
...
class TestBaseUtilities:
    ...
    def test_agent_domain_type_exists(self):
        ...
        from starboard.prompts import AgentDomain
...
class TestBackwardCompatibility:
    ...
    def test_prompts_are_strings(self):
        ...
        from starboard.prompts import QUERY_SYSTEM_PROMPT, ROUTER_SYSTEM_PROMPT
