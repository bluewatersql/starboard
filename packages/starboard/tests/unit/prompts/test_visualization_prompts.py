...
class TestVisualizationPromptV1:
    ...
    def test_few_shot_examples_exist(self):
        ...
        from starboard.prompts.visualization.v1 import FEW_SHOT_EXAMPLES
    ...
    def test_version_constant_exists(self):
        ...
        from starboard.prompts.visualization.v1 import PROMPT_VERSION
...
class TestPromptImports:
    ...
    def test_import_from_package(self):
        ...
        from starboard.prompts.visualization import v1
...
class TestPromptDocumentation:
    ...
    def test_system_prompt_has_docstring(self):
        ...
        from starboard.prompts import visualization
