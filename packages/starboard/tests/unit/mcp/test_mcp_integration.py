...
from starboard.mcp.config import MCPServerConfig, WorkspaceProfile
from starboard.mcp.prompt_bridge import PROMPT_METADATA
...
class TestServerPromptRegistration:
    ...
    @patch("starboard.prompts.factories.get_system_prompt")
