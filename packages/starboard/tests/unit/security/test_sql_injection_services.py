...
class TestValidationHelpers:
    def test_validate_window_days_coerces_numeric_string(self) -> None:
        from starboard.tools.services.validation import validate_window_days
    ...
    def test_qualified_table_name_dotted(self) -> None:
        from starboard.tools.services.validation import QualifiedTableName
...
class TestUCAdapterWhereConditions:
    ...
    def test_invalid_column_name_rejected(self) -> None:
        from starboard.infra.storage.uc_adapter import InvalidColumnError
