...
def get_default_embedding_provider(
    ...
    Example:
        ...
        from starboard.infra.rag import get_default_embedding_provider
    ...
    if api_key and container:
        try:
            from starboard.services.memory.embedding_service import (
                EmbeddingService,
            )
...
def create_mock_provider(embedding_dim: int = 1024) -> MockEmbeddingProvider:
    ...
    Example:
        from starboard.infra.rag import create_mock_provider
