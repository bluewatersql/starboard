...
class ExplorationToolAdapter:
    ...
    Example:
        >>> from starboard.tools.domain.diagnostic.artifact_explorer import ArtifactExplorer
        >>> from starboard.tools.domain.diagnostic.artifact_detector import ArtifactDetector
        >>> from starboard.tools.domain.diagnostic.evidence_extractor import EvidenceWindowExtractor
        >>> from starboard.tools.domain.diagnostic.context_extractor import DatabricksContextExtractor
        >>>
