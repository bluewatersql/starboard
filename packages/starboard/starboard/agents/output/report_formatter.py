...
"""DEPRECATED: Use starboard.agents.report_formatters instead.
...
Migration:
    Old: from starboard.agents.output.report_formatter import format_optimizer_report
    New: from starboard.agents.report_formatters import format_agent_report
"""
...
def format_optimizer_report(complete_report: dict[str, Any]) -> str:
    ...
    warnings.warn(
        ...
        "starboard.agents.report_formatters instead.",
        DeprecationWarning,
        stacklevel=2,
    )
