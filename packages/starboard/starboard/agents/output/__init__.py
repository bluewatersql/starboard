...
Example:
    >>> from starboard.agents.output import BoundaryValidator, EnvelopeTranslator
...
from starboard.agents.output.boundary_validator import (
    BoundaryValidator,
    ValidationResult,
)
...
from starboard.agents.output.envelope_translator import EnvelopeTranslator
