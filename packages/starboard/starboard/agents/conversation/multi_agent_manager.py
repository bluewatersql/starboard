...
from starboard.agents.config.model_generator import DomainModelConfigGenerator
from starboard.agents.conversation import (
...
from starboard.agents.utils.position_tracker import PositionTracker
...
class MultiAgentConversationManager:
    ...
    def _initialize_service_catalog(self) -> None:
        ...
        from starboard.config.catalog_loader import (
            CatalogLoadError,
            load_service_catalog,
        )
        from starboard.services.coordination.next_step_generator import (
            NextStepGenerator,
        )
    ...
    async def get_history(self, conversation_id: str) -> ConversationHistory | None:
        ...
        from starboard.domain.conversation.api_types import Message as APIMessage
        ...
        # Build metadata
        from starboard.domain.conversation.api_types import ConversationMetadata
    ...
    async def handle_message_stream(
        ...
        if route_decision.domain == "diagnostic":
            ...
            if large_file_attachments and self._cache_factory:
                from starboard.agents.events import ThinkingEvent
        ...
        async for event in specialist.run_stream(
            ...
            if isinstance(event, FinalOutputEvent):
                ...
                if next_steps:
                    ...
                    from starboard.agents.serialization import serialize_step
