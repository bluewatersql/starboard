...
from starboard.mcp.auth_context import EnvTokenAuthProvider
...
from starboard.mcp.workspace_registry import DefaultWorkspaceRegistry
...
async def bootstrap_mcp_server(
    ...
    from starboard.agents.agent_factory import AgentFactory as _AgentFactory
    from starboard.agents.config.agent_config import AgentConfig
    from starboard.agents.routing.intent_router import (
