...
from starboard.mcp.config import MCPServerConfig
from starboard.mcp.exceptions import ExecutionError
from starboard.mcp.tool_bridge import PHASE_A_TOOLS
...
class StarboardResourceProvider:
    ...
    def _get_prompt_version(domain: str) -> str:
        ...
        _module_map: dict[str, str] = {
            "query": "starboard.prompts.query",
            "job": "starboard.prompts.job",
            "uc": "starboard.prompts.uc",
            "cluster": "starboard.prompts.cluster",
            "analytics": "starboard.prompts.analytics.v1",
            "warehouse": "starboard.prompts.warehouse",
            "diagnostic": "starboard.prompts.diagnostic",
            "discovery": "starboard.prompts.discovery",
        }
        try:
            import importlib
