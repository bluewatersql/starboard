...
"""
Cluster domain prompts - Version 2 (Jinja2).

System prompt for the cluster configuration and optimization agent.
...
def build_system_prompt(
    ...
    """Build cluster agent system prompt using Jinja2 template.
