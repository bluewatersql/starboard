...
from starboard.prompts.analytics.v2 import (
    build_system_prompt as _analytics_build,
)
from starboard.prompts.base import AgentDomain
from starboard.prompts.cluster.v2 import (
    build_system_prompt as _cluster_build,
)
from starboard.prompts.diagnostic.v2 import (
    build_system_prompt as _diagnostic_build,
)
from starboard.prompts.discovery.v3 import (
    build_system_prompt as _discovery_build,
)
from starboard.prompts.job.v2 import build_system_prompt as _job_build
from starboard.prompts.query.v2 import (
    build_system_prompt as _query_build,
)
from starboard.prompts.router.v2 import (
    build_system_prompt as _router_build,
)
from starboard.prompts.uc.v2 import build_system_prompt as _uc_build
from starboard.prompts.warehouse.v2 import (
