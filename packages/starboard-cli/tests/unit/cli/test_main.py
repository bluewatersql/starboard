...
class TestConfigLoading:
    ...
    def test_merge_env_config_file_precedence(self):
        ...
        with patch("starboard_cli.cli.main.get_config") as mock_get_config:
...
class TestLoggingSetup:
    ...
    def test_setup_cli_logging_debug_mode(self):
        ...
        with patch("starboard_cli.cli.main.logging.basicConfig") as mock_config:
    ...
    def test_setup_cli_logging_with_log_file(self, tmp_path):
        ...
        with (
            ...
            patch("starboard_cli.cli.main.logging.basicConfig"),
        ):
    ...
    def test_setup_cli_logging_suppresses_noisy_loggers(self):
        ...
        with patch("starboard_cli.cli.main.logging.getLogger") as mock_get_logger:
            mock_logger = Mock()
...
class TestMainEntryPoint:
    ...
    def test_main_calls_parse_args(self):
        ...
        with (
            patch("starboard_cli.cli.main.parse_args") as mock_parse,
            patch("starboard_cli.cli.main.asyncio.run") as mock_run,
        ):
    ...
    def test_main_keyboard_interrupt_handling(self):
        ...
        with (
            patch("starboard_cli.cli.main.parse_args"),
            patch("starboard_cli.cli.main.asyncio.run") as mock_run,
        ):
