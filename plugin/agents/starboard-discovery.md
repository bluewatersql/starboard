...
description: >-
  Discover and map a Databricks workspace — enumerate jobs, clusters, warehouses, and Unity Catalog assets to build a comprehensive inventory. Use when the user wants a workspace inventory, a health snapshot, or wants to explore what resources exist in a workspace.
tools: [Bash, Read]
model: sonnet
---
